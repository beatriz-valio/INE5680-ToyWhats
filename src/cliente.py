...
class Cliente:
  ...
  def abrir_menu_principal(self):
    while True:
      print('\n------------------------------------------------------------------------------------------------')
      print('\nOlá,\nBem vindo ao', colored('toyWhats', 'green'), '!\n')
      print(colored('-\nMenu Principal:\n-\nPara "Cadastrar-se" digite 1, "Entrar no toyWhats" digite 2, "Sair" digite 3.', 'blue'))
  ...
  def iniciar_envio_de_mensagens(self, usuario: Usuario):
    print(colored('\n-\nAmbiente de envio de mensagens toyWhats!\n > Para "voltar", digite 0.\n-', 'blue'))
  ...
  def visualizar_mensagens(self, usuario: Usuario):
    print(colored('\n-\nAmbiente de visualização de mensagens toyWhats!\n > Para "voltar", digite 0.\n-\n', 'blue'))
