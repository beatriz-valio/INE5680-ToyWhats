...
## ------------
  ...
  def salvar_dados_usuario(self, nome: str, telefone_celular: str, chave: str, salt: str):
    historico = open("INE5680-Trabalho-Pratico-Implementacao\historico_dados_usuarios.csv", "a+")
  ...
  def guardar_mensagens(self, usuario_remetente: str, usuario_destinatario: str, mensagem_cifrada: str):
    historico = open("INE5680-Trabalho-Pratico-Implementacao\historico_mensagens_usuarios.csv", "a+")
  ...
  def gerar_autentificador(self, nome_usuario: str):
    ...
    url_configuracao_auth = totp.provisioning_uri(nome_usuario, issuer_name="toyWhats")
